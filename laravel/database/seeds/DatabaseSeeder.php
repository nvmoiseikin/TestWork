...
',
        ...
        Solution::create([
            ...
            'text'    => 'Наши специалисты имеют уникальный опыт в инсталляции бесшовного wifi. Мы можем провести радио разведку в вашем доме и указать на наиболее проблемные места, а так же предложить решения на основе проверенного временем оборудования.
Наверняка вы уже страдали от плохого wifi. Множество проблем ждут пользователя, если система wifi в доме собрана не верно. Затухание сигнала, нестабильный сигнал, потеря сети устройствами, дублирование сети - вот лишь некоторые из огромного числа проблем, которые можно решить при помощи нашего оборудования.',
...
Стерео комнаты и пластики - весь этот фетишь никто не отменял и вы сможете сравнить сами что лучше лампа или цифра?',
        ...
        Solution::create([
            ...
            'photos'   => '/site_img/businessnetworking0.jpeg /site_img/businessnetworking1.jpeg /site_img/smart-home.png',
