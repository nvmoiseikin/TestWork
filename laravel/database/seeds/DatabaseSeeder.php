...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Solution::create([
            ...
            'for'      => 'Для дома',
            'title'    => 'Управление',
            'photos'   => '/site_img/manager0.jpg /site_img/smart-home.png /site_img/smart-home.png',
        ...
        Solution::create([
            ...
            'photos'   => '/site_img/homestheatre0.jpg /site_img/smart-home.png /site_img/smart-home.png',
...
Наши специалисты имеют уникальный опыт в инсталляции бесшовного wifi. Мы можем провести радио разведку в вашем доме и указать на наиболее проблемные места, а так же предложить решения на основе проверенного временем оборудования.',
        ...
        Solution::create([
            ...
            'for'      => 'Для дома',
            'title'    => 'Освещение',
            'photos'   => '/site_img/homelighting0.jpeg /site_img/smart-home.png /site_img/smart-home.png',
...
Чтобы не щурится ночью от яркого света и не бродить в кромешной тьме можно создать режим ночной подсветки помещений, который будет автоматически включаться ночью по датчику.',
        ...
        Solution::create([
            ...
            'for'      => 'Для дома',
            'title'    => 'Мультирум',
            'photos'   => '/site_img/multiroom0.png /site_img/smart-home.png /site_img/smart-home.png',
...
Стерео комнаты и пластики - весь этот фетишь никто не отменял и вы сможете сравнить сами что лучше лампа или цифра?',
        ...
        Solution::create([
            ...
            'photos'   => '/site_img/businesssecurity0.jpeg /site_img/businesssecurity1.jpeg /site_img/smart-home.png',
